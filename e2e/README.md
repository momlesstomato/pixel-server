...
- `08_session_connection_e2e_test.go`: validates phase-1 session-connection runtime behavior (availability, latency response, desktop-view ack).
- `09_shutdown_disconnect_e2e_test.go`: validates graceful shutdown session-disconnected signaling and cleanup flow.
